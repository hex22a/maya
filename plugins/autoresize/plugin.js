 ...
 * it's initialized.
 */
maya.PluginManager.add('autoresize', function(editor) {
	 ...
	 */
	function resize(e) {
		var deltaSize, doc, body, docElm, DOM = maya.DOM, resizeHeight, myHeight,
		...
		if (isNaN(myHeight) || myHeight <= 0) {
			...
			myHeight = maya.Env.ie ? body.scrollHeight : (maya.Env.webkit && body.clientHeight === 0 ? 0 : body.offsetHeight);
		}
	...
	// Register the command so that it can be invoked by using maya.activeEditor.execCommand('mceExample');
