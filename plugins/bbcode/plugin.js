...
(function() {
	maya.create('maya.plugins.BBCodePlugin', {
		init: function(ed) {
		...
		getInfo: function() {
			return {
				...
				authorurl: 'http://www.maya.com',
				infourl: 'http://www.maya.com/wiki.php/Plugin:bbcode'
			};
		},
	...
	// Register plugin
	maya.PluginManager.add('bbcode', maya.plugins.BBCodePlugin);
})();