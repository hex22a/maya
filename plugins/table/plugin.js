...
// Included from: js/maya/plugins/table/classes/TableGrid.js
 ...
 * col/row spans.
 *
 * @class maya.tableplugin.TableGrid
 * @private
 */
define("maya/tableplugin/TableGrid", [
	"maya/util/Tools",
	"maya/Env"
], function(Tools, Env) {
	var each = Tools.each;
...
// Included from: js/maya/plugins/table/classes/Quirks.js
 ...
 *
 * @class maya.tableplugin.Quirks
 * @private
 */
define("maya/tableplugin/Quirks", [
	"maya/util/VK",
	"maya/Env",
	"maya/util/Tools"
...
// Included from: js/maya/plugins/table/classes/CellSelection.js
 ...
 *
 * @class maya.tableplugin.CellSelection
 * @private
 */
define("maya/tableplugin/CellSelection", [
	"maya/tableplugin/TableGrid",
	"maya/dom/TreeWalker",
	"maya/util/Tools"
...
// Included from: js/maya/plugins/table/classes/Dialogs.js
 ...
 * ...
 *
 * @class maya.tableplugin.Dialogs
 * @private
 */
define("maya/tableplugin/Dialogs", [
	"maya/util/Tools",
	"maya/Env"
], function(Tools, Env) {
	var each = Tools.each;
...
// Included from: js/maya/plugins/table/classes/Plugin.js
 ...
 *
 * @class maya.tableplugin.Plugin
 * @private
 */
define("maya/tableplugin/Plugin", [
	"maya/tableplugin/TableGrid",
	"maya/tableplugin/Quirks",
	"maya/tableplugin/CellSelection",
	"maya/tableplugin/Dialogs",
	"maya/util/Tools",
	"maya/dom/TreeWalker",
	"maya/Env",
	"maya/PluginManager"
